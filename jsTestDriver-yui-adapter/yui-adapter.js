...
YUI.add('test', function(Y) {
	...
	var TestCaseAdapter  = {
		...
		run: function(){
			...
			for(var i = 0, l = this.cases.length; i < l; i++){
				item = this.cases[i];
				item.wait = item.wait || Y.Test.Case.prototype.wait;
				item.resume = item.wait || Y.Test.Case.prototype.resume;
				TestCase(item.name, item);
			}
		}
	};
	...
	/*
   window.AsynchronousTest = window.AsynchronousTest || AsyncTestCase('AsynchronousTest');

   if(!AsynchronousTest.prototype.testHook){
		AsynchronousTest._callLaters = [];

		AsynchronousTest.call = function(func, time){
			this._callLaters.push({func: func, time: time});
			
		}

	   AsynchronousTest.prototype.testHook = function(queue){
			 queue.call("step1:", function(callbacks) {
					var count = 0;
					
					var myCallback =  callbacks.add(function(){
							++count;
							var _callLaters = AsynchronousTest._callLaters;
							var temp = [];
							Y.Array.each(_callLaters, function(item, index){
							...
							while(temp.length>0){
								var item = temp[0], index= _callLaters.indexOf(item);
								if(item.func){item.func();};
								_callLaters.splice(index, 1);
							}
							if(count<500 || _callLaters.length>0){
								window.setTimeout(myCallback, 1);
							}else{
								delete window.AsynchronousTest;
							}
					});
					window.setTimeout(myCallback, 1);
			  });
   ...
   Y.namespace("Test");
			...
			/**
			 var time = 0;
			  if (Y.Lang.isFunction(args[0])){
				  time = Y.Lang.isNumber(args[1]) ? args[1] : 0;
			  }else{
				  time = Y.Lang.isNumber(args[0]) ? args[0] : 0;
			  }

			window.AsynchronousTest.call(args[0], time);
			return;
			*/
    ...
    Y.Assert = {
        ...
        areEqual : function (expected, actual, message) {
			...
			assertEquals(Y.Assert._formatMessage(message, "Values should be equal."), expected, actual);
        ...
        areNotEqual : function (unexpected, actual, message) {
			 ...
			 Y.Assert._increment();
			  ...
			  try {
				  assertEquals(Y.Assert._formatMessage(message, "Values should not be equal."), unexpected, actual);
				  fail(Y.Assert._formatMessage(message, "Values should not be equal.") || 'Are not equal');
			  } catch (e) { }
        ...
        areNotSame : function (unexpected, actual, message) {
			...
			assertFalse(Y.Assert._formatMessage(message, "Value should be same."), unexpected === actual);
        ...
        areSame : function (expected, actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be same."), expected === actual);
        ...
        isFalse : function (actual, message) {
			...
			assertFalse(Y.Assert._formatMessage(message, "Value should be false."), actual);
        ...
        isTrue : function (actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be true."), actual);
        ...
        isNaN : function (actual, message){
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be NaN."), isNaN(actual));
        ...
        isNotNaN : function (actual, message){
			...
			assertFalse(Y.Assert._formatMessage(message, "Values should not be NaN."), isNaN(actual));
        ...
        isNotNull : function (actual, message) {
			...
			assertFalse(Y.Assert._formatMessage(message, "Values should not be null."), Y.Lang.isNull(actual));
        ...
        isNotUndefined : function (actual, message) {
			...
			assertFalse(Y.Assert._formatMessage(message, "Value should not be undefined."), Y.Lang.isUndefined(actual));
        ...
        isNull : function (actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be null."), Y.Lang.isNull(actual));
        ...
        isUndefined : function (actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be undefined."), Y.Lang.isUndefined(actual));
        ...
        isArray : function (actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be an array."), Y.Lang.isArray(actual));
        ...
        isBoolean : function (actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be a Boolean."), Y.Lang.isBoolean(actual));
        ...
        isFunction : function (actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be a function."), Y.Lang.isFunction(actual));
        ...
        isInstanceOf : function (expected, actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value isn't an instance of expected type."), (actual instanceof expected));
        ...
        isNumber : function (actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be a number."), Y.Lang.isNumber(actual));
        ...
        isObject : function (actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be an object."), Y.Lang.isObject(actual));
        ...
        isString : function (actual, message) {
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be an string."), Y.Lang.isString(actual));
        ...
        isTypeOf : function (expectedType, actualValue, message){
			...
			assertTrue(Y.Assert._formatMessage(message, "Value should be of type " + expectedType + "."), (typeof actualValue == expectedType));
    ...
    Y.assert = function(condition, message){
		...
		assertTrue(Y.Assert._formatMessage(message, "Assertion failed."), Boolean(condition));
